...
import Harmony.NFCScreen.HarmonyNFCUpdateCredentialScreen;
...
public class HarmonyNFCUpdateCredentialsStep {


	HarmonyNFCUpdateCredentialScreen harmonyNFCUpdateCredentialScreen =
			new HarmonyNFCUpdateCredentialScreen((AndroidDriver)
	...
	public void launch_the_application_and_do_accept_and_agree() throws IOException {
		harmonyNFCUpdateCredentialScreen.clickReadAndAcceptedCheckBox();
		harmonyNFCUpdateCredentialScreen.clickOnAcceptButton();
	}
	...
	public void click_on_plus_button_under_home_screen_of_industrial_device() throws IOException {
		harmonyNFCUpdateCredentialScreen.clickOnPlusButton();
	}
	...
	public void enter_valid_username_and_password(String username, String password) throws IOException {
		harmonyNFCUpdateCredentialScreen.enterUserName(username);
		harmonyNFCUpdateCredentialScreen.enterPassword(password);
	}

	@Then("Click On CONNECT button")
	public void click_on_connect_button() throws IOException {
		harmonyNFCUpdateCredentialScreen.clickOnConnectButton();
	}

	@Then("Verify User is Logged-in successfully!")
	public void verify_user_is_logged_in_successfully() throws IOException {
		harmonyNFCUpdateCredentialScreen.verifyLoginErrorMessage();
	}
}
