...
public class HarmonyNFCUpdateCredentialScreen {
    ...
    public HarmonyNFCUpdateCredentialScreen(AndroidDriver driver) {
        this.driver = driver;
    ...
    public void verifyLoginErrorMessage() throws IOException {
        ...
        if (getErrorLoginTitle.equals("Error")) {
            ...
            System.out.println("===============================================");
            System.out.println("You have successfully, Connected to the device!");
            System.out.println("===============================================");
        }
    }
}